			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<select name="Program_Studi" class="form-control" required>
						...
						<option value="Teknik Ekonomi Bisnis">Teknik Ekonomi Bisnis</option>
						<option value="Teknik Rekayasa Industri">Teknik Rekayasa Industri</option>
						<option value="Teknik Ilmu Terapan">Teknik Ilmu Terapan</option>
						<option value="Teknik Industri Kreatif">Teknik Industri Kreatif</option>
						<option value="Teknik Komunikasi Bisnis">Komunikasi Bisnis</option>
					</select>
				</div>
			</div>
			<div class="item form-group">
