...
<html lang="en">
  <head>
	...
	<link rel="icon" href="assets/images/telkom-bandung.png" type="image/ico" />

    <title> Sistem Informasi Akademik Telkom Universitys </title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>
            &nbsp; <a href="index.php" class="fa fa-mortar-board fa-2x" style="color:#fff;"><span><font size="4.95" color="white" face="Helvetica Neue">TELKOM BANDUNG</font></span></a>
            </center>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="assets/images/image.jfif" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>Anila Dwi Lestari</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/image.jfif" alt="">Anila Dwi Lestari
                  </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2020 Anila Dwi Lestari
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
