			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<select name="Program_Studi" class="form-control" required>
						...
						<option value="Teknik Ekonomi Bisnis" <?php if($data['Program_Studi'] == 'Teknik Ekonomi Bisnis'){ echo 'selected'; } ?>>Teknik Ekonomi Bisnis</option>
						<option value="Teknik Rekayasa Industri" <?php if($data['Program_Studi'] == 'Teknik Rekayasa Industri'){ echo 'selected'; } ?>>Teknik Rekayasa Industri</option>
						<option value="Teknik Ilmu Terapan" <?php if($data['Program_Studi'] == 'Teknik Ilmu Terapan'){ echo 'selected'; } ?>>Teknik Ilmu Terapan</option>
						<option value="Teknik Industri Kreatif" <?php if($data['Program_Studi'] == 'Teknik Industri Kreatif'){ echo 'selected'; } ?>>Teknik Industri Kreatif</option>
						<option value="Komunikasi Bisnis" <?php if($data['Program_Studi'] == 'Komunikasi Bisnis'){ echo 'selected'; } ?>>Komunikasi Bisnis</option>
					</select>
				</div>
			</div>
			<div class="item form-group">
